...
class StoredBookNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'BookStoreContract\\Model\\StoredBook') {
            return false;
        }
    ...
    {
        if ($data instanceof \BookStoreContract\Model\StoredBook) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \BookStoreContract\Model\StoredBook();
